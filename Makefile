...
SRC = src/main.c src/player.c src/error.c src/graphics.c src/parser.c src/raycaster.c src/textures.c src/validation.c src/gnl/get_next_line.c src/gnl/get_next_line_utils.c
